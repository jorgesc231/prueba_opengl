...
// NOTA: Version modificada que almacena ints como valor


// should be a prime number larger than the size of the alphabet. 
...
// Inicializa una nueva hash table
...
// Si la llave existe retorna el valor, si no retorna NULL
int ht_search(ht_hash_table* ht, const char* key)
{
	...
	return -1;    // 0 es una location valida en OpenGL
}
